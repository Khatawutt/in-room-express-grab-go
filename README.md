...
- Flipbook (Heyzine): https://heyzine.com/flip-book/c976158379.html
- ปุ่ม "ดูเมนูเต็ม" ในหน้าเว็บจะเปิด `FLIPBOOK_URL` (ลิงก์ Heyzine) ใน `index.html` — ถ้าเว้นว่างจะเปิดลิงก์ Canva แทน
